...
@AllArgsConstructor
@Configuration
public class GestinDeUsuariosApiRouter {

    @Bean
    public RouterFunction<ServerResponse> routerFunctionGestinDeUsuariosApi(GestinDeUsuariosApiHandler handler) {
        return route(POST("/usuarios"), handler::registrarUsuario)
;
    }
}
