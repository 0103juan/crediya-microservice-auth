...
public class RegisterUserRequest {
    ...
    @Positive(message = "El número de identificación debe ser un número positivo.")
    @Digits(integer = 10, fraction = 0, message = "El número de identificación no puede tener más de 10 dígitos.")
